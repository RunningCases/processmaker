...
class Inputdocument
{
     ...
     */
    public function existsTitle($processUid, $title, $inputDocumentUidExclude = "")
    {
        try {
    ...
    public function create($processUid, $arrayData)
    {
        try {
            ...
            if (isset($arrayData["INP_DOC_TITLE"]) && $this->existsTitle($processUid, $arrayData["INP_DOC_TITLE"])) {
    ...
    public function update($inputDocumentUid, $arrayData)
    {
        try {
            ...
            //Verify data
            if (isset($arrayData["INP_DOC_TITLE"]) && $this->existsTitle($processUid, $arrayData["INP_DOC_TITLE"], $inputDocumentUid)) {
                throw (new \Exception(\G::LoadTranslation("ID_INPUT_NOT_SAVE")));
            }
