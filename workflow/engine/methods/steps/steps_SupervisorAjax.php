...
try {
    ...
    switch ($_POST['action']) {
        ...
        case 'assignSupervisorDynaform':
            ...
            G::auditLog('AssignSupervisorDynaform','Assign Supervisor Dynaform in Process "'.$resultProcess['PRO_TITLE'].'"');
            break;
        case 'removeSupervisorDynaform':
            ...
            G::auditLog('RemoveSupervisorDynaform','Remove Supervisor Dynaform in Process "'.$resultProcess['PRO_TITLE'].'"');
            break;
        ...
        case 'assignSupervisorInput':
            ...
            G::auditLog('AssignSupervisorInput','Assign Supervisor Input in Process "'.$resultProcess['PRO_TITLE'].'"');
            break;
        case 'removeSupervisorInput':
            ...
            G::auditLog('RemoveSupervisorInput','Remove Supervisor Input in Process "'.$resultProcess['PRO_TITLE'].'"');
            break;
    }
