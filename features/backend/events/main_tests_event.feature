...
Feature: Events Resources Main Tests
  ...
  Scenario Outline: Create 18 new Event of the project
    ...
    Scenario Outline: Get a Single Events and check some properties
        ...
        | evn_uid_number | evn_description                    | evn_status | evn_related_to | evn_tas_uid_from                 | evn_tas_estimated_duration | evn_time_unit | evn_when | evn_when_occurs | 
        | 1              | Update Event Message, Single 1     | INACTIVE   | MULTIPLE       | 63843886052a5cc066e4c04056414372 | 2                          | DAYS          | 2        | TASK_STARTED    |
        | 7              | Update Event Conditional, Single 1 | INACTIVE   | MULTIPLE       | 63843886052a5cc066e4c04056414372 | 3                          | DAYS          | 2        | TASK_STARTED    |
        | 13             | Update Event Timer, Single 1       | INACTIVE   | MULTIPLE       | 63843886052a5cc066e4c04056414372 | 2                          | DAYS          | 2        | TASK_STARTED    |
