...
Scenario Outline: Create new report tables from dynaform and grid with bad parameters (negative tests)
    ...
    | Field required fld_dyn            | 922677707524ac7417ce345089010125 | REPORT_TABLE_2 | Report Table Desc 2 | workflow           | NORMAL       | 267480685524ac9b3bd5e23004484669 | text1     | TEXT_1     | Text 1      | VARCHAR    | 64         | fecha1    | DATE_1     | Date        | DATE       |            |           | CUSTOM_FIELD_1 | Custom Field 1 | VARCHAR    | 15         | 400        | fld_dyn            |
