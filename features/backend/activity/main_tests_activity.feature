  ...
  Requirements:
    ...
    Scenario Outline: Update the Definition of a Activity and the check if the values had changed
      Given PUT this data:
        ...
        | Update Task1     | 97192372152a5c78f04a794095806311 | update activity task1   | update description | @@PROCESS             | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 0                       | 4                    | HOURS                     |                             | TRUE             | 4            | HOURS        | 1            |              | NORMAL   | Case Title    | Case Description UPDATE | TRUE                | UPDATE Titulo de Notificacion 1 | text                 | Esta es una Notificacion - UPDATE | template.html            |
        | Update Task2     | 95655319552a5c790b69a04054667879 | update activity task2   | update description | @@PROCESS             | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 0                       | 4                    | HOURS                     |                             | TRUE             | 4            | HOURS        | 1            |              | NORMAL   | Case Title    | Case Description UPDATE | TRUE                | UPDATE Titulo de Notificacion 1 | text                 | Esta es una Notificacion - UPDATE | template.html            |
        | Update Task3     | 63843886052a5cc066e4c04056414372 | update activity task3   | update description | @@PROCESS             | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 0                       | 6                    | HOURS                     |                             | TRUE             | 4            | HOURS        | 1            |              | NORMAL   | Case Title    | Case Description UPDATE | TRUE                | UPDATE Titulo de Notificacion 1 | text                 | Esta es una Notificacion - UPDATE | template.html            |
    ...
    Scenario Outline: Get a activity
        ...
        | 97192372152a5c78f04a794095806311 | update activity task1   | update description | @@PROCESS             | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 0                       | 4                    | HOURS                     | TRUE             | 4            | HOURS        | 1            |              | NORMAL   | Case Title    | Case Description UPDATE | TRUE                | UPDATE Titulo de Notificacion 1 | text                 | Esta es una Notificacion - UPDATE |
        | 95655319552a5c790b69a04054667879 | update activity task2   | update description | @@PROCESS             | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 0                       | 4                    | HOURS                     | TRUE             | 4            | HOURS        | 1            |              | NORMAL   | Case Title    | Case Description UPDATE | TRUE                | UPDATE Titulo de Notificacion 1 | text                 | Esta es una Notificacion - UPDATE |
        | 63843886052a5cc066e4c04056414372 | update activity task3   | update description | @@PROCESS             | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 0                       | 6                    | HOURS                     | TRUE             | 4            | HOURS        | 1            |              | NORMAL   | Case Title    | Case Description UPDATE | TRUE                | UPDATE Titulo de Notificacion 1 | text                 | Esta es una Notificacion - UPDATE |
...
Scenario Outline: Update the Definition of a Activity and the check if the values had changed
      Given PUT this data:
        ...
        | activity                         | tas_title | tas_description  | tas_priority_variable          | tas_derivation_screen_tpl | tas_start | tas_assign_type | tas_assign_variable| tas_group_variable | tas_selfservice_timeout | tas_selfservice_time | tas_selfservice_time_unit | tas_selfservice_trigger_uid | tas_transfer_fly | tas_duration | tas_timeunit | tas_type_day | tas_calendar | tas_type | tas_def_title | tas_def_description | tas_send_last_email | tas_def_subject_message | tas_def_message_type | tas_def_message          | tas_def_message_template |
        | 97192372152a5c78f04a794095806311 | Task1     | Case Description | @@SYS_NEXT_USER_TO_BE_ASSIGNED | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 1                       | 2                    | DAYS                      |                             | FALSE            | 2            | DAYS         | 2            |              | ADHOC    | Case Title    | Case Description    | FALSE               | Titulo de Notificacion 1| template             | Esta es una Notificacion | template.html            |
        | 95655319552a5c790b69a04054667879 | Task2     | Case Description | @@SYS_NEXT_USER_TO_BE_ASSIGNED | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 1                       | 2                    | DAYS                      |                             | FALSE            | 2            | DAYS         | 2            |              | ADHOC    | Case Title    | Case Description    | FALSE               | Titulo de Notificacion 1| template             | Esta es una Notificacion | template.html            |
        | 63843886052a5cc066e4c04056414372 | Task3     | Case Description | @@SYS_NEXT_USER_TO_BE_ASSIGNED | template.html             | TRUE      | BALANCED        | @@USER_LOGGED      | @@GROUP_UID        | 1                       | 2                    | DAYS                      |                             | FALSE            | 2            | DAYS         | 2            |              | ADHOC    | Case Title    | Case Description    | FALSE               | Titulo de Notificacion 1| template             | Esta es una Notificacion | template.html            |