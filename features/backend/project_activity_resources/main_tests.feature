...
Feature: Activity Resources Main Tests
  Requirements:
    ...
    Scenario Outline: Get the Properties and Definition of a Activity are exactly three activity
      Given I request "project/<project>/activity/<activity>"
        ...
        | 251815090529619a99a2bf4013294414 | 63843886052a5cc066e4c04056414372 | Task 1    |
