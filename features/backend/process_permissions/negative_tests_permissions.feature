...
Feature: Process Permissions Negative tests
  ...
  Scenario Outline: Create a new Process Permission with bad parameters (negative tests)
      Given POST this data:
        ...
        | Inavlid uid Inputs       | ALL             |                                  | 1               | 34289569752d5673d310e82094574281 | 36792129552e27247a483f6069605623 | 0              | INPUT        |                                  | 35345345346999999999999888888888 |                                  | BLOCK     | 400        | inputDocument    |
        | Inavlid uid Outputs      | DRAFT           | 55416900252e272492318b9024750146 | 1               | 00000000000000000000000000000001 | 36792129552e27247a483f6069605623 | 1              | OUTPUT       |                                  |                                  | 22424242424242442424242424242424 | VIEW      | 400        | outputDocument   |
