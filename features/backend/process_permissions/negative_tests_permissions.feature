...
Feature: Process Permissions Negative tests
  ...
  Scenario Outline: Create a new Process Permission with bad parameters (negative tests)
      Given POST this data:
        ...
        | Invalid urs_uid          | ALL             |                                  | 1               | 00000002256780000000000000000001 | 36792129552e27247a483f6069605623 | 1              | ANY          |                                  |                                  |                                  | VIEW      | 400        | urs_uid          |     
        ...
        | Invalid tas _uid         | ALL             | 12345678909876543210000000000000 | 1               | 34289569752d5673d310e82094574281 | 36792129552e27247a483f6069605623 | 0              | MSGS_HISTORY |                                  |                                  |                                  | BLOCK     | 400        | tas _uid         |
        | Invalid op_task_source   | DRAFT           | 55416900252e272492318b9024750146 | 1               | 00000000000000000000000000000001 | 36792129552000000000000069605623 | 1              | ANY          |                                  |                                  |                                  | VIEW      | 400        | op_task_source   |
        | Inavlid uid Dynaforms    | DRAFT           | 55416900252e272492318b9024750146 | 1               | 11206717452d5673913aa69053050085 | 36792129552e27247a483f6069605623 | 1              | DYNAFORM     | 86859000000000000084654094971976 |                                  |                                  | BLOCK     | 400        | uid Dynaforms    |
        | Inavlid uid Inputs       | ALL             |                                  | 1               | 34289569752d5673d310e82094574281 | 36792129552e27247a483f6069605623 | 0              | INPUT        |                                  | 35345345346999999999999888888888 |                                  | BLOCK     | 400        | uid Inputs       |
        | Inavlid uid Outputs      | DRAFT           | 55416900252e272492318b9024750146 | 1               | 00000000000000000000000000000001 | 36792129552e27247a483f6069605623 | 1              | OUTPUT       |                                  |                                  | 22424242424242442424242424242424 | VIEW      | 400        | uid Outputs      |
        | Invalid op_user_relation |                 |                                  |                 |                                  |                                  |                |              |                                  |                                  |                                  |           | 400        |                  |
