...
Feature: User Main Tests
    ...
    Scenario Outline: Update User and then check if the values had changed
        ...
        | Update usr_firstname, usr_lastname, usr_username | 2          | wilian        | carters      | william      | will@gmail.com    | saim #45    | 555-6522     | BO          | L        | LPB          | 23344444     | Adminsitracion | 44811996752d567110634a1013636964 | 2014-12-12   |                                  | ACTIVE     | PROCESSMAKER_MANAGER   | sample       | sample       |
