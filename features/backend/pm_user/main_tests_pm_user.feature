...
Feature: User Main Tests
    ...
    Scenario Outline: Update User and then check if the values had changed
        ...
        | Test_description                                 | usr_number | usr_firstname | usr_lastname | usr_username | usr_email         | usr_address | usr_zip_code | usr_country | usr_city | usr_location | usr_phone    | usr_position   | usr_replaced_by                  | usr_due_date | usr_calendar                     | usr_status | usr_role               | usr_new_pass | usr_cnf_pass |
        | Update usr_calendar, usr_role                    | 1          | jhon          | smith        | jhon         | jhon@gmail.com    | grenn #344  | 555-6555     | US          | FL       | MIA          | 555-6655-555 | Gerencia       |                                  | 2016-02-15   | 99159704252f501c63f8c58025859967 | ACTIVE     | PROCESSMAKER_ADMIN     | sample       | sample       |
        ...
        | Update usr_status                                | 3          | saraah        | sandler      | saraah       | saraah@gmail.com  | laberh #985 | 555-9999     | AR          | B        | BUE          | 2353643644   | Desarrollo     | 61364466452d56711adb378002702791 | 2014-12-12   | 99159704252f501c63f8c58025859967 | INACTIVE   | PROCESSMAKER_ADMIN     | admin        | admin        |
    ...
    Given that I want to get a resource with the key "usr_uid" stored in session array as variable "usr_uid_<usr_number>"
        ...
        | 1          | jhon          | smith        | jhon         | jhon@gmail.com    | grenn #344  | 555-6555     |  US          | FL       | MIA          | 555-6655-555 | Gerencia       |                                  | 2016-02-15   | 99159704252f501c63f8c58025859967 | ACTIVE     | PROCESSMAKER_ADMIN     | sample       | sample       |
        | 2          | william       | carters      | william      | will@gmail.com    | saim #45    | 555-6522     |  BO          | L        | LPB          | 23344444     | Adminsitracion | 44811996752d567110634a1013636964 | 2014-12-12   |                                  | ACTIVE     | PROCESSMAKER_MANAGER   | sample       | sample       |
        | 3          | saraah        | sandler      | saraah       | saraah@gmail.com  | laberh #985 | 555-9999     |  AR          | B        | BUE          | 2353643644   | Desarrollo     | 61364466452d56711adb378002702791 | 2014-12-12   | 99159704252f501c63f8c58025859967 | INACTIVE   | PROCESSMAKER_ADMIN     | admin        | admin        |
